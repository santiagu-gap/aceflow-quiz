  ...
  return (
    <div>
      ...
      <div className="pt-8 mx-auto w-[80%] md:max-w-2xl">
        ...
        <p className="mb-4">Last updated: February 13, 2024</p>
        <p className="mb-4">
        ...
        <h3 className="text-lg font-bold mb-1">Interpretation</h3>
        <p className="mb-4">
        ...
        <h3 className="text-lg font-bold mb-1">Definitions</h3>
        ...
        <ul className="mb-4">
          ...
          <li className="mb-2">
            <p className="mb-4">
              ...
              in this Agreement) refers to Aceflow.
            </p>
          </li>
          <li className="mb-2">
            <p className="mb-4">
          ...
          <li className="mb-2">
            <p className="mb-4">
              <strong>Website</strong> refers to Aceflow, accessible from{" "}
              <a
                href="https://aceflow-quiz.vercel.app/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://aceflow-quiz.vercel.app/
              </a>
            </p>
          </li>
          <li className="mb-2">
        ...
        <h2 className="text-xl font-bold mb-2">Collecting and Using Your Personal Data</h2>
        <h3 className="text-lg font-bold mb-1">Types of Data Collected</h3>
        ...
        <h4 className="text-lg font-bold mb-1">Tracking Technologies and Cookies</h4>
        <p className="mb-4">
        ...
        <h3 className="text-lg font-bold mb-1">Use of Your Personal Data</h3>
        ...
        <h3 className="text-lg font-bold mb-1">Retention of Your Personal Data</h3>
        <p className="mb-4">
        ...
        <h3 className="text-lg font-bold mb-1">Transfer of Your Personal Data</h3>
        <p className="mb-4">
        ...
        <h3 className="text-lg font-bold mb-1">Delete Your Personal Data</h3>
        <p className="mb-4">
        ...
        <h3 className="text-lg font-bold mb-1">Disclosure of Your Personal Data</h3>
        <h4 className="text-lg font-bold mb-1">Business Transactions</h4>
        <p className="mb-4">
        ...
        <h4 className="text-lg font-bold mb-1">Law enforcement</h4>
        <p className="mb-4">
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h4 className="text-lg font-bold mb-1">Other legal requirements</h4>
        <p className="mb-4">
        ...
        <h3 className="text-lg font-bold mb-1">Security of Your Personal Data</h3>
        <p className="mb-4">
        ...
        <ul className="mb-4">
          <li className="mb-2">By email: aceflow@googlegroups.com</li>
        </ul>
      </div>
    </div>
  );
